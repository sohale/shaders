...
vec2 np_cloud(float t, int num) {
    ...
    cc.vx = 1.5;
    cc.yphase = 0.8;
    ym = cc.yphase + sin(0.5+t*0.01)*0.02;
    np = vec2(cc.x0-fract(cc.px) * cc.vx , ym); // x : -1 1
    }
    ...
    cc.vx = 1.5;
    cc.yphase = 0.88;
    ym = cc.yphase + sin(0.75+t*0.01)*0.03;
    np = vec2(cc.x0-fract(cc.px) * cc.vx , ym); // x : -1 1
    }
    ...
    cc.px = (t+50.0)*0.0071;
    cc.yphase = 0.85;
    ym = cc.yphase + sin(0.5+t*0.042)*0.0095;
   	np = vec2(cc.x0-fract(cc.px) * cc.vx , ym); // x : -1 1
    }
