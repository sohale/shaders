...
vec2 np_cloud(float t, int num) {
    ...
    cc.y0 = 0.8;
    cc.yamp = 0.02;
    ym = cc.y0 + sin(0.5+t*0.01)*cc.yamp;
    }
    ...
    cc.y0 = 0.88;
    cc.yamp = 0.03;
    ym = cc.y0 + sin(0.75+t*0.01) * cc.yamp;
    }
    ...
    cc.y0 = 0.85;
    cc.yamp = 0.0095;
    ym = cc.y0 + sin(0.5+t*0.042)*cc.yamp;
    }
